...
public class Controller implements Initializable {
    ...
    private void onVertexDragged(MouseEvent e, Vertex vertex) {
        ...
        // Add the lines below to update the layout position of the vertex
        vertex.setLayoutX(vertex.getLayoutX() + vertex.getTranslateX());
        vertex.setLayoutY(vertex.getLayoutY() + vertex.getTranslateY());
    }
    ...
    private void onVertexReleased(MouseEvent mouseEvent, Vertex vertex) {
        ...
        if (vertexDelete != null) {
            ...
            // Check if vertex is not already added
        ...
        if (this.tabPane.getSelectionModel().getSelectedItem() == this.gridTab) {
            ...
            switch (selectedGridSort) {
                ...
                case "A*":
                    ...
                    break;
                case "BFS": // Add this case
                    this.textArea.setText(this.observableGridMap.get("BFS"));
                    Dijkstras djk1 = new Dijkstras(this.nodes, this.startNode, this.finishNode, horiz);
                    break;
                default:
...
//                makeGrid();
        ...
        this.leftDropDown.setOnAction((javafx.event.EventHandler<ActionEvent>) gridEvent);
    }
    ...
    private void fillDescriptionMap() {
        ...
        this.observableMap.put("Insertion Sort", "The time complexity of Insertion Sort is O(n^2) in the worst case and average case.");
        ...
        this.observableGridMap.put("BFS", "The time complexity of Breadth-First Search (BFS) is O(V + E), where V is the number of vertices (nodes) and E is the number of edges in the graph.");
    }
