...
public class Arrow extends Group {
    ...
    public Arrow(double x1, double x2, double y1, double y2) {
        ...
        this.getChildren().addAll(this.mainLine, this.headA, this.headB, this.distanceLabel);
    ...
    private void setUpStyleClassStructure() {
        ...
        distanceLabel.getStyleClass().setAll("label");
    ...
    private void updateDistanceLabel() {
        double centerX = (x1.get() + x2.get()) / 2;
        double centerY = (y1.get() + y2.get()) / 2;

        distanceLabel.setLayoutX(centerX);
        distanceLabel.setLayoutY(centerY);
        distanceLabel.setText(distance.get());
    }
